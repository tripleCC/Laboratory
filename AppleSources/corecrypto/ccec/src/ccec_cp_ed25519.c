                           ...
                           ccec_const_projective_point_t t)
{
    ...
    CC_DECL_BP_WS(ws, bp);
    cced25519_point sx = CC_ALLOC_WS(ws, 4 * n);
    cced25519_point tx = CC_ALLOC_WS(ws, 4 * n);

    cced25519_to_ed25519_point_ws(ws, cp, sx, s);
    cced25519_to_ed25519_point_ws(ws, cp, tx, t);
    cced25519_add_points_unified_ws(ws, cp, sx, tx, sx, CCED25519_ADD_POINTS_FLAG_SKIP_T);
    cced25519_from_ed25519_point_ws(ws, cp, r, sx);
...
static const ccec_cp_decl(255) ccec_cp_ed25519_c_params =
{
    .hp = {
        .n = CCN256_N,
        .bitlen = 255,
...
ccec_const_cp_t ccec_cp_ed25519_c(void)
{
    return (ccec_const_cp_t)&ccec_cp_ed25519_c_params;
}

ccec_const_cp_t ccec_cp_ed25519(void)
{
    ...
    return ccec_cp_ed25519_opt();
 #else
    return ccec_cp_ed25519_c();
 #endif
#endif
}
