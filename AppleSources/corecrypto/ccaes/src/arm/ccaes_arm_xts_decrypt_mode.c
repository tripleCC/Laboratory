...
static void *ccaes_xts_decrypt_vng_wrapper(const ccxts_ctx *key, ccxts_tweak *tweak,
                                           size_t nblocks, const void *in, void *out)
{
    return ccaes_xts_decrypt_vng(key, tweak, nblocks, in, out);
}
...
const struct ccmode_xts ccaes_arm_xts_decrypt_mode = {
    ...
    .xts = ccaes_xts_decrypt_vng_wrapper,
