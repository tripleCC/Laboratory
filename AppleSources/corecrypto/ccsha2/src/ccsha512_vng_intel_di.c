...
static void ccsha512_vng_intel_ssse3_compress(ccdigest_state_t c, size_t num, const void *p)
{
    AccelerateCrypto_SHA512_compress_ssse3((uint64_t*) c, num, p);
}

static void ccsha512_vng_intel_avx1_compress(ccdigest_state_t c, size_t num, const void *p)
{
    AccelerateCrypto_SHA512_compress_AVX1((uint64_t*) c, num, p);
}

static void ccsha512_vng_intel_avx2_compress(ccdigest_state_t c, size_t num, const void *p)
{
...
const struct ccdigest_info ccsha512_vng_intel_AVX2_di = {
    ...
    .impl = CC_IMPL_SHA512_VNG_INTEL_AVX2,
};
...
const struct ccdigest_info ccsha512_vng_intel_AVX1_di = {
    ...
    .final = ccsha512_final,
    .impl = CC_IMPL_SHA512_VNG_INTEL_AVX1,
};
...
const struct ccdigest_info ccsha512_vng_intel_SupplementalSSE3_di = {
    ...
    .final = ccsha512_final,
    .impl = CC_IMPL_SHA512_VNG_INTEL_SUPPLEMENTAL_SSE3,
};
