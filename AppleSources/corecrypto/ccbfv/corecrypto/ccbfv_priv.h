...
#ifndef _CORECRYPTO_CCBFV_PRIV_H_
#define _CORECRYPTO_CCBFV_PRIV_H_
...
typedef enum {
    ...
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_INSECURE_N_8_LOGQ_5x18_LOGT_5 = 0,
    // @warning - insecure; use for testing only
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_INSECURE_N_512_LOGQ_4x60_LOGT_20 = 1,
    // below parameters satisfy post-quantum 128-bit security
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_4096_LOGQ_27_28_28_LOGT_13 = 2,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_8192_LOGQ_3x55_LOGT_42 = 3,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_8192_LOGQ_3x55_LOGT_30 = 4,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_8192_LOGQ_3x55_LOGT_29 = 5,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_4096_LOGQ_27_28_28_LOGT_5 = 6,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_8192_LOGQ_3x55_LOGT_24 = 7,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_8192_LOGQ_29_60_60_LOGT_15 = 8,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_8192_LOGQ_40_60_60_LOGT_26 = 9,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_8192_LOGQ_28_60_60_LOGT_20 = 10,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_4096_LOGQ_16_33_33_LOGT_4 = 11,
    // @warning - insecure; use for testing only
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_INSECURE_N_16_LOGQ_60_LOGT_15 = 12,
    CCBFV_PREDEFINED_ENCRYPTION_PARAMS_N_4096_LOGQ_27_28_28_LOGT_6 = 13,
    // Note, if adding extra parameters, consider adding any new moduli to `predefined_min_primitive_roots`
} ccbfv_predefined_encryption_params_t;

/// @brief Number of predefined encryption parameters
#define CCBFV_PREDEFINED_ENCRYPTION_PARAMS_COUNT 14

/// @brief Number of predefined encryption parameters that support SIMD encoding/decoding
#define CCBFV_PREDEFINED_ENCRYPTION_PARAMS_SIMD_COUNT 9
...
typedef struct ccbfv_param_ctx *ccbfv_param_ctx_t;
typedef const struct ccbfv_param_ctx *ccbfv_param_ctx_const_t;
...
CC_NONNULL_ALL CC_PURE size_t ccbfv_param_ctx_sizeof(ccbfv_predefined_encryption_params_t enc_params);
...
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_param_ctx_init(ccbfv_param_ctx_t param_ctx,
                                                       ccbfv_predefined_encryption_params_t encryption_params);
...
CC_NONNULL_ALL CC_PURE bool ccbfv_param_ctx_supports_simd_encoding(ccbfv_param_ctx_const_t param_ctx);

/// @brief Get the plaintext modulus
/// @param param_ctx The context
CC_NONNULL_ALL CC_PURE uint64_t ccbfv_param_ctx_plaintext_modulus(ccbfv_param_ctx_const_t param_ctx);

/// @brief Get the polynomial degree
/// @param param_ctx The context
CC_NONNULL_ALL CC_PURE uint32_t ccbfv_param_ctx_polynomial_degree(ccbfv_param_ctx_const_t param_ctx);

/// @brief Get the number of moduli in the key context
/// @param param_ctx The context
CC_NONNULL_ALL CC_PURE uint32_t ccbfv_param_ctx_key_ctx_nmoduli(ccbfv_param_ctx_const_t param_ctx);

/// @brief Get the number of moduli in the top-level ciphertext context
/// @param param_ctx The context
CC_NONNULL_ALL CC_PURE uint32_t ccbfv_param_ctx_ciphertext_ctx_nmoduli(ccbfv_param_ctx_const_t param_ctx);

/// @brief Get the coefficient moduli
/// @param param_ctx The context
CC_NONNULL_ALL CC_PURE const uint64_t *ccbfv_param_ctx_coefficient_moduli(ccbfv_param_ctx_const_t param_ctx);

/// @brief Get the number of bytes needed to store one polynomial in the key context
/// @param param_ctx The context
CC_NONNULL_ALL CC_PURE size_t ccbfv_param_ctx_key_ctx_poly_nbytes(ccbfv_param_ctx_const_t param_ctx);
...
ccbfv_param_ctx_plaintext_modulus_inverse(uint64_t *inverse, ccbfv_param_ctx_const_t param_ctx, uint64_t x);

// MARK: - RngSeed

/// RNG Seed
struct ccbfv_rng_seed;
typedef struct ccbfv_rng_seed *ccbfv_rng_seed_t;
typedef const struct ccbfv_rng_seed *ccbfv_rng_seed_const_t;

/// @brief Get RNG seed size
/// @return Number of bytes required to hold the RNG seed
CC_WARN_RESULT CC_CONST size_t ccbfv_rng_seed_sizeof(void);

// MARK: - SecretKey

/// Represent a secret key as a polynomial in evaluation format.
struct ccbfv_secret_key;
typedef struct ccbfv_secret_key *ccbfv_secret_key_t;
typedef const struct ccbfv_secret_key *ccbfv_secret_key_const_t;
...
CC_NONNULL_ALL CC_PURE size_t ccbfv_secret_key_sizeof(ccbfv_param_ctx_const_t param_ctx);
...
CC_NONNULL_ALL CC_WARN_RESULT int
ccbfv_secret_key_generate(ccbfv_secret_key_t secret_key, ccbfv_param_ctx_const_t param_ctx, struct ccrng_state *rng);
...
/// @return `CCERR_OK` if key was successfully generated
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_secret_key_generate_from_seed(ccbfv_secret_key_t secret_key,
...
typedef struct ccbfv_plaintext *ccbfv_plaintext_t;
typedef const struct ccbfv_plaintext *ccbfv_plaintext_const_t;

/// @brief Get plaintext size for a polynomial ctx
/// @param param_ctx The parameter context
/// @return Number of bytes required to hold the plaintext object
CC_NONNULL_ALL CC_WARN_RESULT CC_PURE size_t ccbfv_plaintext_sizeof(ccbfv_param_ctx_const_t param_ctx);
...
typedef struct ccbfv_dcrt_plaintext *ccbfv_dcrt_plaintext_t;
typedef const struct ccbfv_dcrt_plaintext *ccbfv_dcrt_plaintext_const_t;

/// @brief Get Double CRT plaintext size for a polynomial ctx
/// @param param_ctx The parameter context
/// @param nmoduli Number of moduli in the RNS representation
/// @return Number of bytes required to hold the plaintext object
CC_NONNULL_ALL CC_WARN_RESULT CC_PURE size_t ccbfv_dcrt_plaintext_sizeof(ccbfv_param_ctx_const_t param_ctx, uint32_t nmoduli);
...
CC_NONNULL_ALL CC_WARN_RESULT int
ccbfv_dcrt_plaintext_encode(ccbfv_dcrt_plaintext_t r, ccbfv_plaintext_const_t ptext, uint32_t nmoduli);
...
/// @return `CCERR_OK` if successful
CC_NONNULL_ALL CC_WARN_RESULT int
ccbfv_decode_simd_uint64(uint32_t nvalues, uint64_t *cc_counted_by(nvalues) values, ccbfv_plaintext_const_t ptext);
...
/// @return `CCERR_OK` if successful
CC_NONNULL_ALL CC_WARN_RESULT int
ccbfv_decode_simd_int64(uint32_t nvalues, int64_t *cc_counted_by(nvalues) values, ccbfv_plaintext_const_t ptext);
...
typedef struct ccbfv_ciphertext_coeff *ccbfv_ciphertext_coeff_t;
typedef const struct ccbfv_ciphertext_coeff *ccbfv_ciphertext_coeff_const_t;

/// Ciphertext object
/// Contains polynomials in evaluation format with the same context
struct ccbfv_ciphertext_eval;
typedef struct ccbfv_ciphertext_eval *ccbfv_ciphertext_eval_t;
typedef const struct ccbfv_ciphertext_eval *ccbfv_ciphertext_eval_const_t;
...
CC_PURE uint32_t ccbfv_ciphertext_fresh_npolys(void);
...
CC_NONNULL_ALL CC_WARN_RESULT CC_PURE size_t ccbfv_ciphertext_sizeof(ccbfv_param_ctx_const_t param_ctx,
                                                                     uint32_t nmoduli,
                                                                     uint32_t npolys);

/// @brief Performs the forward NTT on each polynomial in the ciphertext
/// @param ctext The input/output ciphertext; the output ciphertext can be cast to ccbfv_ciphertext_eval_t
/// @return `CCERR_OK` if successful
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_fwd_ntt(ccbfv_ciphertext_coeff_t ctext);

/// @brief Performs the inverse NTT on each polynomial in the ciphertext
/// @param ctext The input/output ciphertext; the output ciphertext can be cast to ccbfv_ciphertext_coeff_t
/// @return `CCERR_OK` if successful
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_inv_ntt(ccbfv_ciphertext_eval_t ctext);
...
CC_NONNULL((1))
CC_WARN_RESULT size_t ccbfv_serialize_ciphertext_coeff_nbytes(ccbfv_ciphertext_coeff_const_t ctext, const uint32_t *nskip_lsbs);

/// @brief Number of bytes needed to serialize a ciphertext in evaluation format
/// @param ctext Ciphertext to serialize
/// @return Number of bytes needed to hold a serialized version of `ctext`
CC_NONNULL_ALL CC_WARN_RESULT size_t ccbfv_serialize_ciphertext_eval_nbytes(ccbfv_ciphertext_eval_const_t ctext);
...
CC_NONNULL_ALL CC_WARN_RESULT size_t ccbfv_serialize_seeded_ciphertext_coeff_nbytes(ccbfv_ciphertext_coeff_const_t ctext);
...
/// @details The seeded serialization of a ciphertext is the serialization of the first polynomial of the ciphertext and the seed
/// to regenerate the second polynomial of the ciphertext.
CC_NONNULL_ALL CC_WARN_RESULT size_t ccbfv_serialize_seeded_ciphertext_eval_nbytes(ccbfv_ciphertext_eval_const_t ctext);
...
/// @param ctext Ciphertext to serialize
CC_NONNULL_ALL void ccbfv_serialize_ciphertext_coeff_max_nskip_lsbs(uint32_t *nskip_lsbs, ccbfv_ciphertext_coeff_const_t ctext);
...
/// serialization.
CC_NONNULL((2, 3))
CC_WARN_RESULT int ccbfv_serialize_ciphertext_coeff(size_t nbytes,
...
/// @return `CCERR_OK` if the operation is successful
CC_NONNULL_ALL CC_WARN_RESULT int
ccbfv_serialize_ciphertext_eval(size_t nbytes, uint8_t *cc_counted_by(nbytes) bytes, ccbfv_ciphertext_eval_const_t ctext);

/// @brief Deserialize a ciphertext in coefficient format
/// @param ctext The ciphertext where to store the deserialized ciphertext; Must be initialized with `ccbfv_ciphertext_coeff_init`
...
/// @return `CCERR_OK` if the operation is successful
CC_NONNULL((1, 3, 4))
CC_WARN_RESULT int ccbfv_deserialize_ciphertext_coeff(ccbfv_ciphertext_coeff_t ctext,
                                                      size_t nbytes,
...
/// @param ctext The ciphertext where to store the deserialized ciphertext; Must be initialized with `ccbfv_ciphertext_eval_init`
/// @param nbytes Number of bytes in the bytes buffer
/// @param bytes The buffer of bytes to deserialize
/// /// @param param_ctx The parameter context
/// @param nmoduli Number of moduli in the ciphertext context
/// @param npolys Number of polynomials in the ciphertext
/// @return `CCERR_OK` if the operation is successful
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_deserialize_ciphertext_eval(ccbfv_ciphertext_eval_t ctext,
                                                                    size_t nbytes,
                                                                    const uint8_t *cc_counted_by(nbytes) bytes,
                                                                    ccbfv_param_ctx_const_t param_ctx,
                                                                    uint32_t nmoduli,
...
/// @details The seeded serialization of a ciphertext is the serialization of the first polynomial of the ciphertext and the seed
/// to regenerate the second polynomial of the ciphertext.
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_serialize_seeded_ciphertext_coeff(size_t nbytes,
                                                                          uint8_t *cc_counted_by(nbytes) bytes,
                                                                          ccbfv_ciphertext_coeff_const_t ctext);
...
/// to regenerate the second polynomial of the ciphertext.
CC_NONNULL_ALL CC_WARN_RESULT int
ccbfv_serialize_seeded_ciphertext_eval(size_t nbytes, uint8_t *cc_counted_by(nbytes) bytes, ccbfv_ciphertext_eval_const_t ctext);

/// @brief Deserialize a ciphertext in coefficient format using a seed
/// @param ctext The ciphertext where to store the deserialized ciphertext; Must have `ccbfv_ciphertext_fresh_npolys()`
/// polynomials.
/// @param nbytes Number of bytes in the bytes buffer
/// @param bytes The buffer of bytes to deserialize
...
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_deserialize_seeded_ciphertext_coeff(ccbfv_ciphertext_coeff_t ctext,
                                                                            size_t nbytes,
                                                                            const uint8_t *cc_counted_by(nbytes) bytes,
                                                                            ccbfv_rng_seed_const_t seed,
                                                                            ccbfv_param_ctx_const_t param_ctx,
...
/// @details The bytes array is assumed to contain the serialization of the first polynomial and the second polynomial of the
/// ciphertext is represented by the seed.
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_deserialize_seeded_ciphertext_eval(ccbfv_ciphertext_eval_t ctext,
                                                                           size_t nbytes,
                                                                           const uint8_t *cc_counted_by(nbytes) bytes,
                                                                           ccbfv_rng_seed_const_t seed,
                                                                           ccbfv_param_ctx_const_t param_ctx,
...
CC_WARN_RESULT int ccbfv_encrypt_symmetric(ccbfv_ciphertext_coeff_t ctext,
...
/// @return `CCERR_OK` if operation was successful
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_decrypt(ccbfv_plaintext_t ptext,
                                                ccbfv_param_ctx_const_t param_ctx,
                                                ccbfv_ciphertext_coeff_const_t ctext,
                                                ccbfv_secret_key_const_t secret_key);
...
struct ccbfv_relin_key;
typedef struct ccbfv_relin_key *ccbfv_relin_key_t;
typedef const struct ccbfv_relin_key *ccbfv_relin_key_const_t;

/// @brief Returns the number of bytes required to allocate a relinearization key
/// @param param_ctx Parameter context
CC_WARN_RESULT CC_NONNULL_ALL CC_PURE size_t ccbfv_relin_key_sizeof(ccbfv_param_ctx_const_t param_ctx);

/// @brief Generates a relinearization key
/// @param relin_key Relinearization key to generate; should be initialized with `CCBFV_RELIN_KEY_ALLOC_WS`
...
/// `\tilde{Q_j} = q_j`.
CC_WARN_RESULT CC_NONNULL((1, 2, 3, 6)) int ccbfv_relin_key_generate(ccbfv_relin_key_t relin_key,
                                                                     ccbfv_secret_key_const_t secret_key,
                                                                     ccbfv_param_ctx_const_t param_ctx,
                                                                     uint32_t nseeds,
...
ccbfv_relin_key_save(uint32_t nbytes_poly0s, uint8_t *poly0s, ccbfv_relin_key_const_t relin_key);

/// @brief Loads a relinearization key
/// @param relin_key Relinearization key to load; should be initialized with `CCBFV_RELIN_KEY_ALLOC_WS`
/// @param param_ctx Parameter context
...
/// @return CCERR_OK if successful
CC_WARN_RESULT CC_NONNULL_ALL int ccbfv_relin_key_load(ccbfv_relin_key_t relin_key,
                                                       ccbfv_param_ctx_const_t param_ctx,
...
/// `\tilde{P})_{Q_i}(s_A)_j = [s_A * (Q_i / \tilde{Q}_j) * (Q_i / \tilde{Q_j})^{-1}]_{Q_i}` and
/// `\tilde{Q_j} = q_j`.
struct ccbfv_galois_key;
typedef struct ccbfv_galois_key *ccbfv_galois_key_t;
typedef const struct ccbfv_galois_key *ccbfv_galois_key_const_t;
...
CC_WARN_RESULT CC_NONNULL_ALL CC_PURE size_t ccbfv_galois_key_sizeof(ccbfv_param_ctx_const_t param_ctx, uint32_t ngalois_elts);

/// @brief Generates a Galois key
/// @param galois_key Galois key to generate; should be initialized with `CCBFV_GALOIS_KEY_ALLOC_WS`
/// @param ngalois_elts Number of Galois elements in the Galois key
...
/// `\tilde{P})_{Q_i}(s_A)_j = [s_A * (Q_i / \tilde{Q}_j) * (Q_i / \tilde{Q_j})^{-1}]_{Q_i}` and
/// `\tilde{Q_j} = q_j`.
CC_WARN_RESULT CC_NONNULL((1, 3, 4, 5, 8)) int ccbfv_galois_key_generate(ccbfv_galois_key_t galois_key,
...
/// @return CCERR_OK if successful
CC_WARN_RESULT CC_NONNULL_ALL int
ccbfv_galois_key_save(uint32_t nbytes_poly0s, uint8_t *poly0s, ccbfv_galois_key_const_t galois_key);

/// @brief Loads a Galois key
/// @param galois_key Galois key to load; should be initialized with `CCBFV_GALOIS_KEY_ALLOC_WS`
/// @param ngalois_elts Number of Galois elements in the Galois key
/// @param galois_elts List of Galois elements; each should be unique and odd in [3, 2N - 1]
/// @param param_ctx Parameter context
/// @param nbytes_poly0s The number of bytes than are stored in the `poly0s` buffer
...
/// @param seeds Array of RNG seeds that store the seed for the second polynomial of ciphertexts
/// @return CCERR_OK if successful
CC_WARN_RESULT CC_NONNULL_ALL int ccbfv_galois_key_load(ccbfv_galois_key_t galois_key,
                                                        uint32_t ngalois_elts,
...
CC_WARN_RESULT CC_NONNULL_ALL int
ccbfv_ciphertext_galois_elt_rotate_rows_left(uint32_t *galois_elt, uint32_t step, uint32_t degree);
...
/// @details Not constant time; the step and Galois element are considered public
CC_WARN_RESULT CC_NONNULL_ALL int
ccbfv_ciphertext_galois_elt_rotate_rows_right(uint32_t *galois_elt, uint32_t step, uint32_t degree);
...
CC_WARN_RESULT CC_NONNULL_ALL int ccbfv_ciphertext_galois_elt_swap_columns(uint32_t *galois_elt, uint32_t degree);
...
/// @return `CCERR_OK` if successful
CC_WARN_RESULT CC_NONNULL_ALL int ccbfv_ciphertext_apply_galois(ccbfv_ciphertext_coeff_t r,
                                                                ccbfv_ciphertext_coeff_const_t ctext,
                                                                uint32_t galois_elt,
                                                                ccbfv_galois_key_const_t galois_key);

// MARK: - Decomposing ciphertext to plaintexts

/// @brief Returns the number of plaintext polynomials required to decompose a ciphertext
...
CC_NONNULL_ALL uint32_t ccbfv_ciphertext_coeff_decompose_nptexts(ccbfv_ciphertext_coeff_const_t ctext);
...
/// @brief Composes a ciphertext from a plaintext array
/// @param ctext Will store the composed ciphertext; should be initialized (e.g. with ccbfv_ciphertext_coeff_init)
...
/// decomposition is created via `ccbfv_ciphertext_coeff_decompose`.
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_coeff_compose(ccbfv_ciphertext_coeff_t ctext,
                                                                 uint32_t nptexts,
...
/// @details Each coefficient of the ciphertext is composed from the word decomposition
/// `[x % w, (x >> w) % w, (x >> 2 * w) % w, ...]` with base `w = 2^{floor{log_2{t}}`, where `t` is the plaintext modulus. This
/// decomposition is created via `ccbfv_ciphertext_coeff_decompose_skip_lsbs`.
CC_NONNULL((1, 3))
CC_WARN_RESULT
...
/// @brief Decomposes a ciphertext into plaintext polynomials
/// @param nptexts Number of plaintexts
/// @param ptexts Array of pointers to plaintexts
/// @param ctext The ciphertext to decompose
...
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_coeff_decompose(uint32_t nptexts,
...
/// Leaks the ciphertext number of polynomials and context through timing
CC_NONNULL((2, 3))
CC_WARN_RESULT int ccbfv_ciphertext_coeff_decompose_skip_lsbs(
    uint32_t nptexts,
    ccbfv_plaintext_t *cc_counted_by(nptexts) ptexts,
    ccbfv_ciphertext_coeff_const_t ctext,
    const uint32_t *cc_counted_by(ctext->npoly *ccbfv_ciphertext_coeff_ctx(ctext)->dims.nmoduli) skip_lsbs);
...
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_bytes_to_coeffs(size_t ncoeffs,
...
/// @details `ncoeffs` and `nbytes` must be related to each other. Either `ncoeffs` = number of coefficients to hold `nbytes`
/// bytes or `nbytes` = number of bytes to hold `ncoeff` coefficients.
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_coeffs_to_bytes(size_t nbytes,
                                                        uint8_t *cc_counted_by(nbytes) bytes,
                                                        size_t ncoeffs,
...
/// @return `CCERR_OK` if operation was successful
/// @details `ctext` must have exactly `ccbfv_ciphertext_fresh_npolys()` polynomials. And `r` must be have the same context and
/// shape as `ctext`.
CC_NONNULL_ALL CC_WARN_RESULT int
ccbfv_ciphertext_plaintext_add(ccbfv_ciphertext_coeff_t r, ccbfv_ciphertext_coeff_const_t ctext, ccbfv_plaintext_const_t ptext);
...
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_coeff_plaintext_mul(ccbfv_ciphertext_coeff_t r,
                                                                       ccbfv_ciphertext_coeff_const_t ctext,
                                                                       ccbfv_plaintext_const_t ptext);
...
/// @return `CCERR_OK` if the operation was successful
/// @details `r` and `ctext` should not overlap, unless `r == ctext`
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_coeff_dcrt_plaintext_mul(ccbfv_ciphertext_coeff_t r,
                                                                            ccbfv_ciphertext_coeff_const_t ctext,
...
/// @return `CCERR_OK` if the operation was successful
/// @details `r` and `ctext` should not overlap, unless `r == ctext`
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_eval_plaintext_mul(ccbfv_ciphertext_eval_t r,
...
/// @return `CCERR_OK` if the operation was successful
/// @details `r` and `ctext` should not overlap, unless `r == ctext`
CC_NONNULL_ALL CC_WARN_RESULT int ccbfv_ciphertext_eval_dcrt_plaintext_mul(ccbfv_ciphertext_eval_t r,
                                                                           ccbfv_ciphertext_eval_const_t ctext,
                                                                           ccbfv_dcrt_plaintext_const_t ptext);

#endif /* #if CC_PRIVATE_CRYPTOKIT */

#endif /* _CORECRYPTO_CCBFV_PRIV_H_ */
